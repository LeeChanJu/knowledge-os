...
Something presented as true that still needs supporting evidence. “Our tool is faster” is a claim; a measured comparison would be evidence.

A model may suggest that Joule Studio belongs to a particular ecosystem; a reviewer must inspect the source.

Verification claims such as F1 concern implementation correctness; they are not domain assertions.

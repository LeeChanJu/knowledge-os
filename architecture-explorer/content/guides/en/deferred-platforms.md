Use measured requirements before adding infrastructure. The current boundary is source-derived authorization; provider activation needs reproducible quality evidence. A new authorization engine is not implied by this site.

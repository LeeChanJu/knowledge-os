A new record explicitly replaces an earlier record while preserving it.

## The problem at this stage

Publish a corrected edition instead of erasing the old one. A correction should explain history rather than silently rewrite it.
...
The accepted contract requires a single successor and preserves assertion subject/predicate. Historical and current views must be distinguished.

Governed correction validates the target and records a successor relationship.

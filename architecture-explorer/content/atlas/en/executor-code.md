GraphStore execution claims and outcome records are separate from Notion provider calls. A mismatched policy reviewer must be blocked before acquiring a claim.

Inspect regressions injecting an operations-store failure after Neo4j commits. The criterion is truthful commit reporting and exactly one reconciled audit on retry.

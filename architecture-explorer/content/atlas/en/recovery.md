A backup file differs from a successful isolated restore and read. Follow the branch through artifact verification, isolated restoration and reading the restored state.
